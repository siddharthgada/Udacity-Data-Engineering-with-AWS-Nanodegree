...
#
    @task()
    def drivers_under_18(*args, **kwargs):
    ...
    @task()
    def how_often_bike_ridden(*args, **kwargs):
        redshift_hook = PostgresHook("redshift")
    ...
    @task()
    def stations_count_by_city(*args, **kwargs):
        redshift_hook = PostgresHook("redshift")
    ...
    drivers_under_18_task = drivers_under_18()
    how_often_bike_ridden_task = how_often_bike_ridden()
    stations_count_by_city_task = stations_count_by_city()
    ...
    drivers_under_18_task >> drop_oldest_task
    how_often_bike_ridden_task >> drop_oldest_task
    stations_count_by_city_task >> drop_oldest_task
